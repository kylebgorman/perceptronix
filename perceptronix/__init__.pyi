...
class DenseBinomialModel:
    averaged: bool = ...
    def __init__(self, nfeats: int, c: int = ...) -> None: ...
...
class DenseMultinomialModel:
    averaged: bool = ...
    def __init__(self, nfeats: int, nlabels: int, c: int = ...) -> None: ...
    def average(self) -> None: ...
...
class SparseBinomialModel:
    averaged: bool = ...
    def __init__(self, nlabels: int, c: int = ...) -> None: ...
    def average(self) -> None: ...
...
class SparseBinomialSequentialModel:
    averaged: bool = ...
    def __init__(self, nfeats: int, order: int, c: int = ...) -> None: ...
    def average(self) -> None: ...
...
class SparseDenseMultinomialSequentialModel:
    averaged: bool = ...
    def __init__(
        self, nfeats: int, nlabels: int, order: int, c: int = ...
    ) -> None: ...
    def average(self) -> None: ...
