...
class DenseBinomialModel:
    averaged: bool = ...
    def __init__(self, nfeats: int, c: float = ...) -> None: ...
...
class DenseMultinomialModel:
    averaged: bool = ...
    def __init__(self, nfeats: int, nlabels: int, c: float = ...) -> None: ...
    def average(self) -> None: ...
...
class SparseBinomialModel:
    averaged: bool = ...
    def __init__(self, nlabels: int, c: float = ...) -> None: ...
    def average(self) -> None: ...
...
class SparseBinomialSequentialModel:
    averaged: bool = ...
    def __init__(self, nfeats: int, order: int, c: float = ...) -> None: ...
    def average(self) -> None: ...
...
class SparseDenseMultinomialSequentialModel:
    averaged: bool = ...
    def __init__(
        self, nfeats: int, nlabels: int, order: int, c: float = ...
    ) -> None: ...
    def average(self) -> None: ...
